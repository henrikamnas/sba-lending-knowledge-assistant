...
loan regulations with source attribution.
"""

import streamlit as st

from config import OPENAI_API_KEY, COLLECTION_NAME, LLM_MODEL, EMBEDDING_MODEL, TOP_K
from retrieval import retrieve, get_collection_stats
from llm import generate_response_stream, format_context
...
def _ensure_indexed():
    """Run ingestion automatically if the ChromaDB collection is empty."""
...
# --- Main Content ---
st.title("📋 SBA Lending Knowledge Assistant")
st.markdown(
...
# --- Chat Input ---
# Pick up a demo question if one was clicked
