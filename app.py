...
pg = st.navigation(
    [
        st.Page("pages/0_QA_Assistant.py", title="Q&A Assistant"),
        st.Page("pages/1_Knowledge_Graph.py", title="Knowledge Graph"),
        st.Page("pages/2_Entity_Linker.py", title="Entity Linker"),
    ]
)
